...
savel_model_fn = 'resnet18'
old_model = '../checkpoint/' + 'inception_v3_0817_0622.pkl'

model = MyResNet(18, len(set(train_lbs)))
...
with SummaryWriter(comment='Zalo_ResNet18') as w:
